            ...
            <body>
                <div id="container">
                    ...
                    <div id="left">
                        ...
                        <section>
                            <p class="city-title">Forlì-Cesena</p>
                            <xsl:for-each select="event-list/event">
                                <xsl:if test="location/district = 'FC'">
                                    <article>
                            ...
                            <p class="city-title">Ravenna</p>
                            <xsl:for-each select="event-list/event">
                                <xsl:if test="location/district = 'RA'">
                                    <article>
                                        <xsl:attribute name="class">
                                            <xsl:value-of select="location/district"/>
                                            <xsl:text> </xsl:text>
                            ...
                            <p class="city-title">Rimini</p>
                            <xsl:for-each select="event-list/event">
                                <xsl:if test="location/district = 'RN'">
                                    <article>
                                        <xsl:attribute name="class">
                                            <xsl:value-of select="location/district"/>
                                            <xsl:text> </xsl:text>
