            ...
            <body>
                <div id="container">
                    ...
                    <div id="left">
                        ...
                        <section>
                            <p class="type-title">Concerto</p>
                            <xsl:for-each select="event-list/event">
                                <xsl:if test="type = 'Concerto'">
                                    <article>
                            ...
                            <p class="type-title">Conferenza</p>
                            <xsl:for-each select="event-list/event">
                                <xsl:if test="type = 'Conferenza'">
                                    <article>
                                        <xsl:attribute name="class">
                                            <xsl:value-of select="location/district"/>
                                            <xsl:text> </xsl:text>
                            ...
                            <p class="type-title">Fiera</p>
                            <xsl:for-each select="event-list/event">
                                <xsl:if test="type = 'Fiera'">
                                    <article>
                                        <xsl:attribute name="class">
                                            <xsl:value-of select="location/district"/>
                                            <xsl:text> </xsl:text>
                            ...
                            <p class="type-title">Mostra</p>
                            <xsl:for-each select="event-list/event">
                                <xsl:if test="type = 'Mostra'">
                                    <article>
                                        <xsl:attribute name="class">
                                            <xsl:value-of select="location/district"/>
                                            <xsl:text> </xsl:text>
                            ...
                            <p class="type-title">Sagra</p>
                            <xsl:for-each select="event-list/event">
                                <xsl:if test="type = 'Sagra'">
                                    <article>
                                        <xsl:attribute name="class">
                                            <xsl:value-of select="location/district"/>
                                            <xsl:text> </xsl:text>
                            ...
                            <p class="type-title">Spettacolo</p>
                            <xsl:for-each select="event-list/event">
                                <xsl:if test="type = 'Spettacolo'">
                                    <article>
                                        <xsl:attribute name="class">
                                            <xsl:value-of select="location/district"/>
                                            <xsl:text> </xsl:text>
