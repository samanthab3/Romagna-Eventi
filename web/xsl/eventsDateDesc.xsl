        ...
        <html>
            ...
            <body>
                <div id="container">
                    ...
                    <div id="left">
                        <nav id="menu">
                            <a id="date-sort" href="eventsDateAsc.html">Ordina per data</a>
                        ...
                        <section>
                            <xsl:for-each select="event-list/event">
                                <xsl:sort select="period/start/date/year" order="descending"/>
                                <xsl:sort select="period/start/date/month" order="descending"/>
                                <xsl:sort select="period/start/date/day" order="descending"/>
                                <article>
